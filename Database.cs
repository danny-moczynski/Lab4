   ...
   // string mainDir = FileSystem.Current.AppDataDirectory;
    ...
    public bool UpdateAirport(Airport airportToUpdate, String city, DateTime DateVisited, int rating)
    {
        try
        {
            ...
            cmd.Parameters.AddWithValue("City", city); // Use the parameter 'city' instead of airportToUpdate.City
            cmd.Parameters.AddWithValue("DateVisited", DateVisited); // Use the parameter 'DateVisited' instead of airportToUpdate.DateVisited
            cmd.Parameters.AddWithValue("Rating", rating); // Use the parameter 'rating' instead of airportToUpdate.Rating
